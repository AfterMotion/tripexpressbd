...
Trip Express BD is a **Chattogram-based group-tour operator**. They are not an OTA,
not a flight aggregator, not a luxury concierge. They assemble small teams (7–15
travellers is typical) and personally lead them across borders, then publish the
photographs and the safe-return note afterwards.

Everything on the website flows from that: **a person you can phone, a team you join,
photographs that are theirs.**
...
| Attribute | Shows up as |
|---|---|
| **Warm** | Sunset orange dominance, real faces, first-person copy |
| **Trustworthy** | Published itineraries, inclusions/exclusions, bank details, office address |
| **Energetic** | The 17° Flight Angle, motion that departs, active verbs |
| **Local** | Bangla-first copy, Chattogram pride, community tone |
| **Proof-driven** | The portfolio/gallery is a primary section, not a footer link |

Explicitly **not**: aloof luxury, aggressive discounting, corporate blue-chip,
influencer gloss.
...
render correctly at every size.
...
- A public Facebook page with ~5.9K followers and a deep archive of completed tours
- Real tour photography from Nepal, Kashmir, Meghalaya, Maldives, Sri Lanka, Kolkata
- A physical office in Chattogram with a documented opening event
- A partnership with the **তাঁবু নিবাসী** travel group
...
- **Itinerary:** day-by-day, each day with a route line and bullet activities
- **Includes:** return air ticket, transfers, hotels (2/3-star, double/triple
  sharing), daily breakfast + dinner, sightseeing transport, professional guide
- **Excludes:** lunch, rides, personal expenses, travel insurance, extras
- **Booking deadline:** an explicit date
- **Booking method:** bank deposit or cash at office; balance before departure
- **Contact:** three phone numbers + WhatsApp link

Every package page and package card on the site must be able to express all of
these fields. Design for them.
